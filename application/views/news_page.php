...
<html>
  <head>
      ...
      <!-- Font Awesome -->
      <link rel="stylesheet" href="<?php echo base_url().'asset'?>/plugins/font-awesome/4.5.0/css/font-awesome.min.css">
      <!-- Ionicons -->
      <link rel="stylesheet" href="<?php echo base_url().'asset'?>/plugins/ionicons/2.0.1/css/ionicons.min.css">
      <!-- Theme style -->
          ...
          <div class="row">
              <div class="col-md-6" style="">
                <div class="box box-info">
                      ...
                      <!-- /.box-header -->
                      <!-- form start -->
                      <form class="form-horizontal" method="POST" action="<?php echo base_url().'index.php/news/insert'?>" enctype="multipart/form-data">
                        <div class="box-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <textarea name="content" rows="15" cols="40" placeholder="Content" class="form-control"></textarea>
                            </div>
                          </div>
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="sub-category" placeholder="Sub Category">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="ori_site" placeholder="Original Site">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="ori_url" placeholder="Original URL">
                            </div>
                          </div>
                          <div class="form-group">
